      ...
      <Layout>
        <Content style={{ margin: '24px 16px', padding: 24, background: '#fff', minHeight: 280, }}>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div>
              <UploadDuplicate upload_text="Atrribute to Skillset" apiLink={'http://localhost:8080/api/uploadattribute2skillset'} shouldShow={true} colors={DataVizColors} />
            </div>
            <div>
              <UploadDuplicate upload_text="Event to Attribute" apiLink={'http://localhost:8080/api/uploadevent2attribute'} shouldShow={true} colors={DataVizColors} />
            </div>
          </div>
        </Content>
        <ViewUploadedFiles />
